...
TSMP_FIELD_FIELD_NAME = 1 << 11
TSMP_FIELD_CHILD_INDEX = 1 << 12
TSMP_FIELD_NAMED = 1 << 13
TSMP_FIELD_DEPTH = 1 << 14
...
FIELD_NAMES = {
    ...
    "field_name": TSMP_FIELD_FIELD_NAME,
    "field": TSMP_FIELD_FIELD_NAME,
    "child_index": TSMP_FIELD_CHILD_INDEX,
    "named": TSMP_FIELD_NAMED,
    "is_named": TSMP_FIELD_NAMED,
    "depth": TSMP_FIELD_DEPTH,
    "all": TSMP_FIELD_ALL,
}
