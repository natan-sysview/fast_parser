...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--version", required=True, help="NuGet package version, for example 0.1.0-preview.17")
...
def validate_package(package: Path) -> None:
    required = {
        ...
        "examples/csharp/04_query/Program.cs",
        "examples/csharp/04_query/FastParse.QueryExample.csproj",
