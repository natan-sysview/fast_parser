/**
 * @file Java frameworks grammar for tree-sitter
...
const PRIMEFACES_BACKEND_TYPES = [
  'AbstractChartModel',
  'AjaxBehavior',
  'BarChartModel',
  'Carousel',
...
const PRIMEFACES_BACKEND_METHODS = [
  'ajax',
  'closeDialog',
  'current',
  'execute',
...
module.exports = grammar({
  ...
  rules: {
    ...
    string_literal: $ => choice($.jdbc_connection_string, $._string_literal, $._multiline_string_literal),
    jdbc_connection_string: _ => token(seq('"', /jdbc:(?:oracle|sqlserver|mysql|postgresql|db2|h2|derby)[^"\\]*/, '"')),
    _string_literal: $ => seq(
      '"',
      repeat(choice(
        $.string_fragment,
    ...
    jsf_backend_object_creation_expression: $ => prec.right(PREC.OBJ_INST + 1, seq(
      'new',
      choice(
        seq(
          repeat($._annotation),
      ...
      field('type', choice($.jsf_backend_type, $.jsf_backend_generic_type)),
      field('arguments', $.argument_list),
      optional($.class_body),
    )),

    primefaces_backend_object_creation_expression: $ => prec.right(PREC.OBJ_INST + 1, seq(
      'new',
      choice(
        seq(
          repeat($._annotation),
      ...
      field('type', choice($.primefaces_backend_type, $.primefaces_backend_generic_type)),
      field('arguments', $.argument_list),
      optional($.class_body),
    )),
    ...
    jsf_backend_static_field_access: $ => prec(PREC.OBJ_ACCESS + 1, seq(
      field('object', $.jsf_backend_type),
      '.',
      field('field', choice($.identifier, $._reserved_identifier)),
    )),

    primefaces_backend_static_field_access: $ => prec(PREC.OBJ_ACCESS + 1, seq(
      field('object', $.primefaces_backend_type),
      '.',
      field('field', choice($.identifier, $._reserved_identifier)),
    )),
    ...
    jsf_context_method_invocation: $ => prec(PREC.OBJ_ACCESS + 1, seq(
      field('object', $.jsf_backend_type),
      '.',
      field('name', $.jsf_context_method_identifier),
      field('arguments', $.argument_list),
    )),

    primefaces_backend_method_invocation: $ => prec(PREC.OBJ_ACCESS + 1, seq(
      field('object', $.primefaces_backend_type),
      '.',
      field('name', $.primefaces_backend_method_identifier),
      field('arguments', $.argument_list),
    )),
    ...
    framework_marker_annotation: $ => prec(1, seq(
      '@',
      field('name', choice($.framework_annotation_identifier, $.framework_scoped_annotation_name, $.framework_qualified_annotation_name)),
    )),

    framework_annotation: $ => prec(1, seq(
      '@',
      field('name', choice($.framework_annotation_identifier, $.framework_scoped_annotation_name, $.framework_qualified_annotation_name)),
      field('arguments', $.annotation_argument_list),
    )),

    framework_scoped_annotation_name: $ => seq(
      $.framework_annotation_identifier,
      repeat1(seq('.', $.identifier)),
    ),

    framework_qualified_annotation_name: $ => seq(
    ...
    framework_import_declaration: $ => prec(1, seq(
      'import',
      optional('static'),
      field('name', $.framework_qualified_name),
      optional(seq('.', $.asterisk)),
      ';',
    )),

    framework_qualified_name: _ => token(prec(1, choice(
      /org\.springframework(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.persistence(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.persistence(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.hibernate(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /java\.sql(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.sql(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.axis(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.axis2(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.xml\.bind(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.xml\.bind(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.xml\.ws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.xml\.ws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.jws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.jws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /net\.sf\.jasperreports(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.bouncycastle(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /io\.jsonwebtoken(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /springfox(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.thoughtworks\.xstream(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /lombok(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.fasterxml\.jackson(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.google\.gson(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.slf4j(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.log4j(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.logging\.log4j(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.commons(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.http(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.apache\.axiom(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /io\.swagger(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.aspectj(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.jboss\.logging(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.ws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.ws(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.mail(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.mail(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.activation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.activation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.crypto(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.servlet(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.servlet(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.faces(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.faces(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.primefaces(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.transaction(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.transaction(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.inject(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.inject(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.validation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.validation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.junit(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /junit\.framework(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.mockito(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.itextpdf(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.google\.firebase(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.nimbusds\.jose(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.jose4j(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.jasypt(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.ulisesbocchio\.jasyptspringboot(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.jfree(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /ch\.qos\.logback(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /io\.netty(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /reactor\.netty(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.google\.auth(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /org\.json(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /net\.coobird\.thumbnailator(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /javax\.annotation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /jakarta\.annotation(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /oracle\.jdbc(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /oracle\.sql(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
      /com\.microsoft\.sqlserver\.jdbc(?:\.[A-Za-z_][A-Za-z0-9_]*)*/,
    ))),

    framework_annotation_identifier: _ => token(choice(...FRAMEWORK_ANNOTATIONS)),
    ...
    jsf_backend_type: _ => token(prec(1, choice(...JSF_BACKEND_TYPES))),

    jsf_context_method_identifier: _ => token(choice(...JSF_CONTEXT_METHODS)),

    primefaces_backend_type: _ => token(prec(1, choice(...PRIMEFACES_BACKEND_TYPES))),

    primefaces_backend_method_identifier: _ => token(choice(...PRIMEFACES_BACKEND_METHODS)),

    jsf_backend_generic_type: $ => prec(PREC.GENERIC + 1, seq(
      $.jsf_backend_type,
      $.type_arguments,
    )),

    primefaces_backend_generic_type: $ => prec(PREC.GENERIC + 1, seq(
      $.primefaces_backend_type,
      $.type_arguments,
    )),
