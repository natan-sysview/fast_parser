...
```bash
pip install fastparse-0.1.0rc12-py3-none-macosx_11_0_arm64.whl
```

Python package versions use PEP 440. A FastParse release named `0.1.0-preview.12` is published to PyPI as `0.1.0rc12`.
